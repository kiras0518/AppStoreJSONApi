...
//    }
//
//    var appFullBeginOffset: CGFloat = 0
//
...
//            appFullBeginOffset = appFullscreenController.tableView.contentOffset.y
//        }
//
//        if gesture.state == .changed {
//            if translationY > 0 {
//
//                let tureOffset = translationY - appFullBeginOffset
//
//                var scale = 1 - translationY / 1000
//
//                print("scale", scale, "tureOffset", tureOffset)
//
//                scale = min(1, scale)
//                scale = max(0.5, scale)
//
